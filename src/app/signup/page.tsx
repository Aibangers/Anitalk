    ...
    <div className="flex min-h-[calc(100vh-10rem)] items-center justify-center px-4 py-12">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-muted mt-1">Join the anime discussion community</p>
        </div>
        ...
        <div className="rounded-2xl bg-surface border border-border p-6">
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <button
              type="submit"
              className="w-full rounded-lg bg-gradient-to-r from-accent-purple to-accent-blue py-2.5 text-sm font-semibold text-white hover:opacity-90 transition-opacity"
            >
              Create Account
            </button>
          </form>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button className="flex items-center justify-center gap-2 rounded-lg border border-border py-2.5 text-sm font-medium hover:bg-surface-hover transition-colors">
